...
| 1.1 | 2026-01-09 | wuzhiguocarter | Next.js 升级到 16.1.1，启用 Turbopack、React Compiler 和 Cache Components |
...
| 层级         | 技术组件                 | 版本号                | 选型理由                                                                  |
| ---------- | -------------------- | ------------------ | --------------------------------------------------------------------- |
| 前端框架       | Next.js (App Router) | 16.1.1             | 官方最新版本，集成 Turbopack（构建速度提升 2-5x）、React Compiler（自动优化）、Cache Components（新缓存模型），基于最新 React 特性（Server Components、Suspense），提供完整的全栈开发体验 |
